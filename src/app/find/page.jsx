        ...
        <div className="md:col-span-1">
          <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-6 sticky top-24">
            ...
            <div className="mt-4 grid gap-4 text-sm">
              ...
              <button type="button" className="inline-flex items-center justify-center gap-2 rounded-2xl bg-emerald-600 dark:bg-emerald-500 text-white px-4 py-2 hover:bg-emerald-700 dark:hover:bg-emerald-600">
